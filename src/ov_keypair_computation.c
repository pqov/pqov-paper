...
void calculate_F2( unsigned char * F2, const unsigned char * P1 , const unsigned char * P2 , const unsigned char * sk_t1 )
{
...
void ov_pkc_calculate_F_from_Q( sk_t * Fs)
{
    calculate_F2( Fs->L , Fs->P1 , Fs->L , Fs->t1 );
}
#endif
...
void calculate_F2_P3( unsigned char * F2, unsigned char * P3, const unsigned char * P1 , const unsigned char * P2 , const unsigned char * sk_t1 )
{
...
void calculate_P3( unsigned char * P3, const unsigned char * P1 , const unsigned char * P2 , const unsigned char * sk_t1 )
{
...
{
  calculate_P3( Qs->P3 , Fs->P1 , Fs->L , Ts->t1 );
}
